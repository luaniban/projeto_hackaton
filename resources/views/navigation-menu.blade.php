        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @if (Laravel\Jetstream\Jetstream::hasTeamFeatures())
                    <div class="ms-3 relative animate-section delay-3">
                ...
                <!-- Settings Dropdown -->
                <div class="ms-3 relative animate-section delay-4">
            ...
            <!-- Hamburger -->
            <div class="-me-2 flex items-center sm:hidden animate-section delay-5">
